...
IBtn.addEventListener("click", () => poseI());
LBtn.addEventListener("click", () => poseL());
YBtn.addEventListener("click", () => poseY());
GuessBtn.addEventListener("click", () => poseGuess());

function poseI(){
machine.learn(poseData, "I")
    console.log(poseData)
    console.log("Pinky finger (I)")
}

function poseL(){
    machine.learn(poseData, "L")
    console.log(poseData)
    console.log("Index and thumb (L)")
}

function poseY(){
    machine.learn(poseData, "Y")
    console.log(poseData)
    console.log("Shaka sign, thumb and Pinky (Y)")
}

function poseGuess(){
    let prediction = machine.classify(poseData)
    console.log(`You got the ${prediction}`)
    document.getElementById("prediction").innerHTML = `You are posing the:${prediction}`;
}
